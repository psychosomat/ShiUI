          ...
          <div className="flex items-center gap-2">
            <span
              className={
                  ...
                  ? "flex h-6 w-6 items-center justify-center bg-sumi font-mono text-[11px] text-paper"
                  : "flex h-6 w-6 items-center justify-center border-[1.5px] border-sumi font-mono text-[11px]"
              }
            >
              {done && !cur ? "✓" : `0${i + 1}`}
            </span>
