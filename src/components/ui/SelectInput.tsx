  ...
  return (
    <div className={cn("w-full", className)} {...props}>
      ...
      <div className="relative">
        <select
          id={id}
          className="w-full appearance-none border-[1.5px] border-sumi bg-paper px-3.5 py-2.5 pr-10 font-sans text-[14px] focus:border-shu focus:outline-none"
        >
          <option>Washi — kozo</option>
          <option>Washi — mitsumata</option>
