  ...
  return (
    <div className={cn("border-[1.5px] border-sumi bg-paper p-5 text-center", className)} {...props}>
      ...
      <ul className="space-y-1.5 font-sans text-[13px]">
        ...
        <li>✓ Washi wrapping</li>
        <li className="opacity-40">× Framing</li>
      </ul>
      <button
        type="button"
        className="mt-4 w-full border-[1.5px] border-sumi bg-sumi py-2 font-mono text-[11px] uppercase tracking-[0.16em] text-paper hover:bg-shu"
      >
        Choose
      </button>
    </div>
