    ...
    <div className={cn("flex w-full max-w-xs items-center gap-3 border-[1.5px] border-shu bg-paper p-3.5", className)}>
      ...
      {answered ? (
        <span className="font-sans text-[13px] font-bold">
          {answered === "yes" ? "Discarded. The rack is clear." : "Kept. Still on the rack."}
        </span>
      ) : (
        <span className="font-sans text-[13px] font-bold">
          ...
          <span className="mt-2 flex gap-2">
            <button
              ...
              className="cursor-pointer border border-sumi px-2.5 py-1 font-mono text-[10px] uppercase hover:bg-sumi hover:text-paper"
            >
              Keep
            </button>
            <button
              ...
              className="cursor-pointer bg-shu px-2.5 py-1 font-mono text-[10px] uppercase text-paper"
            >
              Discard
            </button>
          </span>
